                            ...
                            <div class="border border-3 p-4 rounded">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="product_short_description" class="form-control"
                                              ...
                                              rows="3" required>{{$data->product_short_description}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="mytextarea"
                                              name="product_long_description"> {{$data->product_long_description}}
                                    </textarea>
                                    <small style="color: #e20000" class="error"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row" id="preview_img" style="padding: 20px">
                                        @foreach($productImages as $item)
                                            <img class="thumb" src="{{url('uploads/images/product/' .
                                            $item->product_image)}}" style="max-width: 200px; margin-top: 20px"
                                                 alt="product image"/>
                                        @endforeach
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="brand_id" class="form-select" id="inputProductType">
                                            ...
                                            @foreach($brands as $item)
                                                <option value="{{$item->brand_id}}" {{$item->brand_id ==
                                                $data->brand_id ? 'selected' : null}}
    ...
    <script>
        ...
        $(document).ready(function(){
            $('#multi_image').on('change', function(){ //on file input change
                ...
                $('#preview_img').html(''); // removes the old images (UI)
