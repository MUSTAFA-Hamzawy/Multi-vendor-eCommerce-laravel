                    ...
                    @foreach($data as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="exampleVerticallycenteredModal-{{$item->brand_id}}" tabindex="-1"
                                     aria-hidden="true">
                            ...
                            <td>
                                <div class="d-flex order-actions">
                                    ...
                                    <div class="modal fade" id="exampleFullScreenModal-{{$item->brand_id}}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-fullscreen">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <form class="brand_form" action="{{route
                                                            ('admin-brand-update')
                                    ...
                                    <a href="" class="ms-3" data-bs-toggle="modal"
                                       data-bs-target="#exampleDangerModal-{{$item->brand_id}}">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="exampleDangerModal-{{$item->brand_id}}" tabindex="-1" style="display: none;" aria-hidden="true">
